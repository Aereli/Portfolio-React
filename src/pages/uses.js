...
import SplitString2 from "../components/stringSplitter2"
      ...
      <>
        <div className="uses-container">
          ...
          <ul>
            ...
            <li>Chrome as my web browser</li>
            <li>
              <a
          ...
          <ul>
            ...
            <li>
              ...
              plugin that autocompletes file names
            </li>
            <li>
              <a
            ...
            <li>
              ...
              provides lots of icons based on Material Design for Visual Studio
              Code.
            </li>
          </ul>
          <h3>Hardware</h3>
          <ul>
            <li>
              MacBook Pro Retina, 13-inch, Mid 2014 | 2.6 GHz Dual-Core Intel
              Core i5
            </li>
            <li>Iphone 11</li>
            <li>Apple Watch 3</li>
